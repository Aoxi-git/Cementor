...
O.engines=[
	...
	InteractionLoop(
		[Ig2_Sphere_Sphere_ScGeom(interactionDetectionFactor=1.2),Ig2_Box_Sphere_ScGeom(interactionDetectionFactor=1.2)],
...
def transitions():
    ...
    if phase==2 and doShear:
        ...
        else: print("stabilize with bridges")

from yade import plot
def history():
	plot.addData(e11=-triax.strain[0], e22=-triax.strain[1]-e22_0, e33=-triax.strain[2],
